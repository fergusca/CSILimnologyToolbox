...
def dropfields(fc):
    try:
        ...
        arcpy.AddField_management(fc, "CWS_Area_ha","DOUBLE")
        arcpy.CalculateField_management(fc, "CWS_Area_ha", "!shape.area@hectares!", "PYTHON")
        arcpy.AddField_management(fc, "CWS_Perim_km", "DOUBLE")
        arcpy.CalculateField_management(fc, "CWS_Perim_km", "!shape.length@kilometers!", "PYTHON")
        del fields
        del dropfields
    except:
